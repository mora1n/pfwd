...
PFWD_GUARD_XDP_PIN_PATH="${PFWD_GUARD_XDP_PIN_PATH:-/sys/fs/bpf/pfwd_guard_xdp}"
...
PFWD_ADDRESS_CONTROL_STATE_DIR="${PFWD_ADDRESS_CONTROL_STATE_DIR:-$PFWD_STATE_DIR/address_control}"
PFWD_ADDRESS_CONTROL_ALLOW_IPV4_FILE="${PFWD_ADDRESS_CONTROL_ALLOW_IPV4_FILE:-$PFWD_ADDRESS_CONTROL_STATE_DIR/allow_ipv4.txt}"
PFWD_ADDRESS_CONTROL_ALLOW_IPV6_FILE="${PFWD_ADDRESS_CONTROL_ALLOW_IPV6_FILE:-$PFWD_ADDRESS_CONTROL_STATE_DIR/allow_ipv6.txt}"
PFWD_ADDRESS_CONTROL_FAMILY="${PFWD_ADDRESS_CONTROL_FAMILY:-inet}"
PFWD_ADDRESS_CONTROL_TABLE="${PFWD_ADDRESS_CONTROL_TABLE:-pfwd_addrctl}"
